...
<br> 1. At least 6 components, since the cumulative pct of explained variance is 52.29 at component 6
<br> 2. 5 yr T-Notes US and 10 yr T-notes have the highest weights of 0.93 of the first principal component.
<br> 3. Interpretation of the first 10 components.
<br> 1) North American Government Bonds
<br> 2) Foreign currencies
<br> 3) European stock market
<br> 4) North American stock market
<br> 5) European Bonds
<br> 6) Oil and gas
<br> 7) Industrial Metal
<br> 8) Industrial Seed Oils
<br> 9) Precious Metal
<br> 10) Asian stock market
<br> 4. 
<br> 5. 
...
<br> 1. The code calculates moving averages of the future prices in different time windows, then scale the price down to enable $1/day investment across all futures. 
<br> 2. You can change the code in line 194 `MAfreq<-seq(10,250,by=20)`, and input different numbers - for example, `MAfreq<-seq(5,250,by=20)`
